...
const Solution = () => {
  ...
  return (
    <section id="solution" className="py-8 sm:py-12 md:py-16 lg:py-24">
      <div className="container-narrow px-4 sm:px-6">
        ...
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-mono-bold mb-3 sm:mb-4">
            How we <span className="underline decoration-green-500 decoration-[2px] sm:decoration-[3px]">solve</span> it
          </h2>
        ...
        >
          <h3 className="text-lg sm:text-xl md:text-2xl font-mono-bold text-left mb-3 sm:mb-4 md:mb-6">
            Our <span className="underline decoration-blue-500 decoration-[1.5px] sm:decoration-[2px]">6-step</span> process
          </h3>
          <TerminalDemo />
        </motion.div>
        ...
        >
          <div className="text-left mb-4 sm:mb-6 md:mb-8">
            <h3 className="text-lg sm:text-xl md:text-2xl font-mono-bold mb-2 sm:mb-3 md:mb-4">
              Real-time <span className="underline decoration-purple-500 decoration-[1.5px] sm:decoration-[2px]">security</span> checks
            </h3>
