...
const TerminalDemo = () => {
  ...
  const demoSteps = useMemo(() => [
    ...
    {
      step: "Escrow",
      command: "[HOLD] $50,000 held in escrow",
    ...
    {
      step: "Release",
      command: "[OK] Funds released to seller",
  ...
  return (
    <div className="bg-background/50 rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-6 font-mono text-[11px] sm:text-xs md:text-sm border border-border w-full max-w-2xl mx-auto overflow-hidden shadow-light">
      {/* Terminal Header */}
      <div className="flex items-center gap-1.5 sm:gap-2 mb-2.5 sm:mb-3 md:mb-4 pb-2 border-b border-border">
        ...
        <span className="text-muted-foreground ml-2 sm:ml-3 md:ml-4 text-[10px] sm:text-xs md:text-sm truncate">bloxtr8-escrow</span>
      </div>
      ...
      <div className="space-y-2.5 sm:space-y-3 md:space-y-4">
        ...
        >
          ...
          <span className="text-foreground font-medium text-[10px] sm:text-xs md:text-sm break-words">
        ...
        <motion.div
          ...
          exit={{ opacity: 0, x: 20 }}
          transition={{ duration: 0.5 }}
          className="flex items-start gap-1.5 sm:gap-2 md:gap-3 bg-muted/50 p-2 sm:p-2.5 md:p-3 rounded-lg overflow-x-auto"
        >
          <span className="text-green-600 dark:text-green-400 flex-shrink-0 mt-0.5">$</span>
          <span className="text-foreground break-words text-[11px] sm:text-xs md:text-sm leading-relaxed">
        ...
        {/* Step Counter */}
        <div className="text-muted-foreground text-[9px] sm:text-[10px] md:text-xs mt-1 sm:mt-1.5 md:mt-2">
