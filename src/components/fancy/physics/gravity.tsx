  ...
  (
    ...
    const registerElement = useCallback(
      (id: string, element: HTMLElement, props: MatterBodyProps) => {
        ...
        // Matter.js body creation helpers are strict about `chamfer` not being `null`.
        // Fancy components allow passing `Matter.IBodyDefinition` which types `chamfer` as `IChamfer | null`,
        // so we normalize `null` to `undefined` for compatibility.
